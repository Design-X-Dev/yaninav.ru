  ...
  return (
    <InfoPageLayout>
      ...
      <div className="space-y-8 text-base leading-relaxed" style={{ color: text }}>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold mb-3" style={{ color: heading }}>Самовывоз</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold mb-3" style={{ color: heading }}>Способы оплаты</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="font-display text-xl font-semibold mb-3" style={{ color: heading }}>Доставка по России</h2>
          <p className="mb-4">
            Доставка ювелирных изделий осуществляется специализированными транспортными компаниями, имеющими
            необходимые разрешения для перевозки ценностей. Отправка в другие города возможна через надёжные службы;
            детали по страхованию и отслеживанию отправления согласуются индивидуально.
          </p>
          <h3 className="font-display text-lg font-semibold mb-2" style={{ color: heading }}>Срок доставки</h3>
          <p className="mb-3">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4">
            <li>до пункта выдачи (ПВЗ): выберите удобный пункт самовывоза рядом с домом или офисом;</li>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold mb-3" style={{ color: heading }}>Документы и гарантии</h2>
          <p>
            К изделиям при необходимости выдаются сертификаты и сопроводительные документы. Общие гарантийные условия
            описаны на странице{' '}
            <Link href="/warranty" className="text-accent-primary underline hover:no-underline">«Гарантии»</Link>
            ; юридические условия покупки — в{' '}
            <Link href="/offer" className="text-accent-primary underline hover:no-underline">публичной оферте</Link>
            .
          </p>
        </section>
