...
export type FooterContactChannels = {
  phoneDisplay: string;
  phoneHref: string;
  emailDisplay: string;
  emailHref: string;
...
interface FooterClientProps {
  channels: FooterContactChannels;
}
          ...
          <div>
            ...
            <div className="space-y-3" style={{ color: textColor }}>
              ...
              <div className="flex items-center space-x-2">
                ...
                <a href={phoneHref} className="text-sm hover:text-accent-primary transition-colors">{phoneDisplay}</a>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-accent-primary mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href={emailHref} className="text-sm hover:text-accent-primary transition-colors break-all">{emailDisplay}</a>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-accent-primary mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
